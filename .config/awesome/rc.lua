-- The default file is /etc/xdg/awesome/rc.lua
...
-- terminal = "xterm"
terminal = "urxvt -bg black -fg green"
...
globalkeys = awful.util.table.join(
    ...
    -- Standard program
    -- To identify a key - use xev
    -- @TODO move to xmodmap/xbindkeys?
    awful.key({                   }, "XF86AudioRaiseVolume", function () awful.util.spawn("amixer set Master 1+") end),
    awful.key({ "Shift"           }, "XF86AudioRaiseVolume", function () awful.util.spawn("amixer set Master 5+") end),
    awful.key({                   }, "XF86AudioLowerVolume", function () awful.util.spawn("amixer set Master 1-") end),
    awful.key({ "Shift"           }, "XF86AudioLowerVolume", function () awful.util.spawn("amixer set Master 5-") end),
    ...
    awful.key({ "Shift"           }, "XF86AudioPrev", function () awful.util.spawn("mocp -k 10") end),
    awful.key({ "Ctrl"            }, "XF86AudioPrev", function () awful.util.spawn("mocp -k 60") end),
    awful.key({                   }, "XF86AudioNext", function () awful.util.spawn("mocp -f") end),
    awful.key({ "Shift"           }, "XF86AudioNext", function () awful.util.spawn("mocp -k -10") end),
    awful.key({ "Ctrl"            }, "XF86AudioNext", function () awful.util.spawn("mocp -k -60") end),
    ...
    awful.key({                   }, "XF86PowerOff", function () awful.util.spawn("sudo /sbin/shutdown -h now'") end),
    awful.key({ "Shift"           }, "XF86WakeUp", function () awful.util.spawn("sudo /sbin/shutdown -h now'") end),
    awful.key({ "Control"         }, "XF86WakeUp", function () awful.util.spawn("sudo /sbin/reboot'") end),

    awful.key({                   }, "XF86Launch1", function () awful.util.spawn("awsetbg -r .config/awesome/backgrounds") end),
